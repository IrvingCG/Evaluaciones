...
?>
        ...
        <div class="col-lg-5 col-md-7">
            ...
            <div class="alert bg-danger alert-dismissible fade show text-white" role="alert">
              <font class="lead"><strong><i class="fas fa-exclamation"></i> TRABAJO EXTRA <i class="fas fa-exclamation"></i></strong></font><p class="lead"> Revisa en la sección de <b>FOROS</b> y participa, cada participación tuya cuenta.</p>
